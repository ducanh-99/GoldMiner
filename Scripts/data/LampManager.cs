...
public class LampManager : MonoBehaviour
{
    ...
    public static int SALE_COUNT = 3;
    ...
    private static Dictionary<string, Powerup> powers_dict = new Dictionary<string, Powerup>()
    {
        {
            "Dynamite",
            new Powerup("Dynamite","Thuốc nổ","Ném thuốc nổ để phá hủy vật thể đang kéo lên!",0,"dynamite")},
        {
            "StoneCollection",
            new Powerup("StoneCollection","Bộ sưu tập đá","Tăng giá trị của đá lên 3 lần",0,"stone_collection")
        },
        {
            "LuckyFlower",
            new Powerup("LuckyFlower","Hoa may mắn","Tăng xác xuất nhận được đồ giá trị trong túi bí mật",0,"lucky_flower")
        },
        {
            "Oil",
            new Powerup("Oil","Dầu bôi trơn","Tăng tốc độ di chuyển của xe goòng(nhanh về đích)",0,"oil")
        },
        {
            "PolishDiamond",
            new Powerup("PolishDiamond","Đánh bóng kim cương","Tăng giá trị kim cương lên 2 lần",0,"polish_diamond")
        },
        {
            "PowerDrink",
            new Powerup("PowerDrink","Volka","Khỏe như gấu, tăng tốc độ kéo vật",0,"power_drink")
        },
        {
            "TimePlus",
            new Powerup("TimePlus","Đồng hồ cát","Tăng thời gian thêm 20s",0,"time_plus")
        }
    };
    ...
    public static LampManager Instance {
        get {
            if (instance == null) {
                instance = new GameObject("LampManager").AddComponent<LampManager>();
